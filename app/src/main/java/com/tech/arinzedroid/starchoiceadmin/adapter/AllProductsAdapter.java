...
import com.tech.arinzedroid.starchoiceadmin.viewHolder.AllProductsViewHolder;

import java.util.List;

public class AllProductsAdapter extends RecyclerView.Adapter<AllProductsViewHolder> {

    private List<ProductsModel> productsModelList;
    private ProductItemClickedInterface productItemClickedInterface; private int count;

    public AllProductsAdapter(List<ProductsModel> productsModels,
    ...
    public AllProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllProductsViewHolder(v,productItemClickedInterface);
    }
